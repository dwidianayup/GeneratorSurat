        ...
        *********************************************************************************************************************************************************** -->
        ...
        <section id="main-content">
            <section class="wrapper site-min-height">
            	<h3><i class="fa fa-angle-right"></i> Form Pembuatan Surat Open Stand</h3>
            	<div class="row mt">
            		<div class="col-lg-12">
                  <div class="form-panel">
                    ...
                    <form class="form-horizontal style-form" action="surat2.php" method="post">
                      <!-- TANGGAL -->
                  ...
                  <div class="form-panel">
                    ...
                    <div class="">
                      ...
                      <p style="text-align:justify;">
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        Dengan hormat, 
                      <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Sehubungan dengan akan diadakannya Seminar Nasional Release Party TeaLinuxOS 9 “Open Source dan Kehidupan” oleh Dinus Open Source Community (DOSCOM), kami atas nama panitia bermaksud memohon izin untuk membuka stand sebagai tempat pendaftaran di gedung H lantai 1 atau 2, dan gedung D yang akan dilaksanakan pada : </p>
                      <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Hari/Tanggal  &nbsp;&nbsp;&nbsp;: Selasa – Jumat , 2 - 12 Mei 2017</p>
                      <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Waktu   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: 07.00 – 17.00 WIB </p>
                      <p>Demikian surat pemberitahuan ini kami sampaikan. Atas perhatian Bapak/Ibu kami ucapkan terima kasih.
                      </p><br><br>
