        ...
        *********************************************************************************************************************************************************** -->
        ...
        <section id="main-content">
            <section class="wrapper site-min-height">
            	<h3><i class="fa fa-angle-right"></i> Form Pembuatan Surat Peminjaman Kabel EasyCAP</h3>
            	<div class="row mt">
            		<div class="col-lg-12">
                  <div class="form-panel">
                    ...
                    <form class="form-horizontal style-form" action="surat1.php" method="post">
                      <!-- TANGGAL -->
                      ...
                      <div class="form-group col-sm-12">
                        ...
                        <div class="col-sm-3">
                          <input type="text" class="form-control" ng-model="hal" name="hal" required="" ng-model="hal">
                        </div>
                      </div>
                      <div class="form-group col-sm-12">
                  ...
                  <div class="form-panel">
                    ...
                    <div class="">
                      ...
                      <p style="text-align:justify;">
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        Dengan hormat, 
                      <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Sehubungan dengan akan diadakannya Seminar Nasional Release Party TeaLinuxOS 9 “Open Source dan Kehidupan” oleh Dinus Open Source Community (DOSCOM), kami atas nama panitia bermaksud memohon izin untuk meminjam kabel EasyCAP RCA untuk live streaming acara tersebut yang akan dilaksanakan pada : </p>
