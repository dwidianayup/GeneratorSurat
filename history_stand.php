...
<table class="table table-stripped table-hover">
    ...
    while ($data=mysqli_fetch_assoc($hasil)) {
        ...
        <tr>
            ...
            <td><a href='surat_stand.php?id=<?php echo $data['no']; ?>'>lihat pdf</a> <a href='delete.php?id=<?php echo $data['no'];?>&kat=<?php echo $data['kategori']; ?>' class="btn btn-danger">hapus</a></td>
        </tr>
        <?php  
        $no++;
    }
